...
namespace EnvanterTakip
{
    public partial class OrderModuleForm : Form
    {
        ...
        public void LoadCustomer()
        {
            ...
            {
                i++;
                dgvCstmr.Rows.Add(i, dr[0].ToString(), dr[1].ToString());
            }
            dr.Close();
            con.Close();
        }
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Stok miktarı yeterli değil!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            txtCId.Text = dgvCstmr.Rows[e.RowIndex].Cells[1].Value.ToString();
            txtCName.Text = dgvCstmr.Rows[e.RowIndex].Cells[2].Value.ToString();
        }
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtPid.Text == "")
                {
                    MessageBox.Show("Lütfen ürün seçin!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (MessageBox.Show("Bu siparişi eklemek istediğinize emin misiniz?", "Kayıt Ediliyor", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
